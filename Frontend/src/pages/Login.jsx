            ...
            <div className='w-full h-full flex-1 flex items-center justify-center '>
                <form className="flex flex-col items-start justify-start gap-2 w-full h-fit max-w-[350px] ">
                    <label className='w-full'>
                        ...
                        <input required type="email" name='email' placeholder='E.g. johndoe@gmail.com' className="w-full h-[35px] ring-1 bg-transparent ring-border-lines-light p-4 outline-none rounded-md text-sm focus:ring-button-color/10 focus:ring-2 " id="" />
                    </label>
                    <label className='w-full'>
                        <h1 className='mb-2 font-semibold'>Password</h1>
                        <div className="w-full h-fit relative">
                            <input required type={showPassword ? 'text' : 'password'} placeholder='Enter your password' className="w-full h-[35px] ring-1 bg-transparent ring-border-lines-light p-4 outline-none rounded-md text-sm focus:ring-button-color/10 focus:ring-2 " id="" />
