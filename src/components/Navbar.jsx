...
function Navbar() {
  ...
  return (
    <div className={`h-[65px] px-16 w-full flex items-center justify-between tracking-tight sticky top-0 transition-all ${scrolled ? 'text-text-color-black bg-body-white' : 'text-text-color-white main-header'} `}>
      {/* Logo & Links */}
